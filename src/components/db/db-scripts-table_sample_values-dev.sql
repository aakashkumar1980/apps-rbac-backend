...
INSERT INTO ROLE_FEATURES (role_id, features_id) VALUES
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='PRODUCT_LIST')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='ORDER_MANAGEMENT')),   
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='CUSTOMER_REVIEWS')),    
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='STUDENT_DIRECTORY')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='COURSE_MANAGEMENT')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM FEATURES WHERE code='EXAM_SCHEDULE')),
    ((SELECT id FROM ROLE WHERE code='RESEARCHER'), (SELECT id FROM FEATURES WHERE code='E-COM_ANALYTICS')),
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM FEATURES WHERE code='PRODUCT_LIST')),    
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM FEATURES WHERE code='CUSTOMER_REVIEWS')),
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM FEATURES WHERE code='STUDENT_DIRECTORY'));
