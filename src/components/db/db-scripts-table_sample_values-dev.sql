...
INSERT INTO ROLE_APPFEATURES (role_id, appfeatures_id) VALUES
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='PRODUCT_LIST')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='ORDER_MANAGEMENT')),   
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='CUSTOMER_REVIEWS')),    
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='STUDENT_DIRECTORY')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='COURSE_MANAGEMENT')),
    ((SELECT id FROM ROLE WHERE code='ADMIN'), (SELECT id FROM APPFEATURES WHERE code='EXAM_SCHEDULE')),
    ((SELECT id FROM ROLE WHERE code='RESEARCHER'), (SELECT id FROM APPFEATURES WHERE code='E-COM_ANALYTICS')),
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM APPFEATURES WHERE code='PRODUCT_LIST')),    
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM APPFEATURES WHERE code='CUSTOMER_REVIEWS')),
    ((SELECT id FROM ROLE WHERE code='USER'), (SELECT id FROM APPFEATURES WHERE code='STUDENT_DIRECTORY'));
...
INSERT INTO USER_APPS_ROLES (email, app_id, role_id) VALUES
    ...
    ('kavita.raikwar@adesigners.com', (SELECT id FROM APP WHERE code='E-COMMERCE'), (SELECT id FROM ROLE WHERE code='USER')),
